<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cameraList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="摄像头ID" align="center" prop="id" />
      <el-table-column label="摄像头名称" align="center" prop="name" />
      <el-table-column label="经度" align="center" prop="longitude" />
      <el-table-column label="纬度" align="center" prop="latitude" />
      <el-table-column label="视频流地址" align="center" prop="streamUrl" />
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('Camera/camera/export', {
        ...this.queryParams
